...
-- Migration 004 is checksum-pinned and already deployed. Replace only the
-- exchange function so row presence depends on its non-null primary key;
-- PostgreSQL composite IS NULL / IS NOT NULL semantics are field-wise.
