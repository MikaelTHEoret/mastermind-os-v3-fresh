...
const result=spawnSync('C:/Python314/python.exe',[path.join(directory,'canonical-schema-activation.py'),...process.argv.slice(2)],{
  env:{...process.env,NEON_MEMORY_DSN:process.env.NEON_MEMORY_URL},encoding:'utf8',timeout:120000,maxBuffer:262144,windowsHide:true});
