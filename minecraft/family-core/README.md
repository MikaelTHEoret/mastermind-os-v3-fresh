...
The exact 50,772-byte 0.5.0 candidate JAR was reproduced twice with SHA-256 `9C3138DC8C7830B514A9714D4F1DF329A220FA87EC06F53D6BC516A03B333AC8`. Thirty focused Node protocol/bridge/credential/identity tests and eight Java tests pass, including role-claim rejection, registry-tamper failure, schema-v1 credential recovery, and rejection of unadvertised chat events. Promotion and live chat acceptance remain separate gates. Model reasoning, profile capture, administration, shutdown, companion telemetry, and companion events remain disabled.
